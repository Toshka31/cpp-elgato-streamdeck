//
// Created by anton on 03.03.24.
//

#include "ServerGRPC.h"

ServerGRPC::ServerGRPC(uint16_t port, std::shared_ptr<DeviceController> dev_ctrl,
                       std::shared_ptr<ModuleLoader> mod_ctrl)
                       : m_device_controller(dev_ctrl)
                       , m_module_loader(mod_ctrl)
{
...
grpc::Status ServerGRPC::GetComponents(grpc::ServerContext *context,
...
grpc::Status ServerGRPC::GetDevices(grpc::ServerContext *context,
                                    const google::protobuf::Empty *request,
...
grpc::Status ServerGRPC::GetDeviceProfiles(grpc::ServerContext *context,
...
grpc::Status
ServerGRPC::GetDeviceCurrentProfile(grpc::ServerContext *context,
                                    const StreamDeckAPI::DeviceRequest *request,
...
grpc::Status ServerGRPC::SetDeviceCurrentProfile(grpc::ServerContext *context,
...
grpc::Status ServerGRPC::GetDevicePages(grpc::ServerContext *context,
                                        const StreamDeckAPI::DeviceRequest *request,
...
grpc::Status ServerGRPC::GetDeviceCurrentPage(grpc::ServerContext *context,
                                              const StreamDeckAPI::DeviceRequest *request,
...
grpc::Status ServerGRPC::SetDeviceCurrentPage(grpc::ServerContext *context,
...
grpc::Status ServerGRPC::GetDeviceBrightness(grpc::ServerContext *context,
                                             const StreamDeckAPI::DeviceRequest *request,
...
grpc::Status ServerGRPC::SetDeviceBrightness(grpc::ServerContext *context,
...
grpc::Status ServerGRPC::SetDeviceButtonImage(grpc::ServerContext *context,
...
grpc::Status ServerGRPC::SetDeviceButtonLabel(grpc::ServerContext *context,
...
grpc::Status ServerGRPC::SetDeviceButtonModuleComponent(grpc::ServerContext *context,
